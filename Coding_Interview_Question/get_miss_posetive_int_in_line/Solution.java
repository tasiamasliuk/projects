public class Solution {
    public static int get_miss_posetive_in_line(int[] arr){
        ...
        if (arr[arr.length - 1]+1 > 0 && arr[arr.length - 1] > 0){
            if (arr[arr.length - 1]+1 < posetive_int)
                posetive_int = arr[0]-1;
        }
        return posetive_int;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("positive integer in line thet was missed: " + get_miss_posetive_in_line(check_me_1));

        int[] check_me_2 = {1,2,0};
        System.out.println("positive integer in line thet was missed: " + get_miss_posetive_in_line(check_me_2));
    }
}
