public class Solution {
    public static int decoder(String data){
        ...
        if (0 < Integer.parseInt(data) && Integer.parseInt(data) <= 9){
            System.out.println("0 < " + Integer.parseInt(data) + " <= 9");
            return 1;
        }


        if (0 < Integer.parseInt(data.substring(0,2)) && Integer.parseInt(data.substring(0,2)) < 27){
            System.out.println("decode " + data.substring(1) + " + " + data.substring(2));
            ...
            {
                System.out.println("decode " + data.substring(1));
